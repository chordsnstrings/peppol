...
export const LEDGER_NAV: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/accounting/notifications", label: "Notifications" },
      ...
      { href: "/accounting/numbering", label: "Document numbering" },
    ],
  },
  {
    key: "sales",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/accounting/landed-cost", label: "Landed cost" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/accounting/cash-flow-direct", label: "Cash flow, direct" },
      ...
      { href: "/accounting/related-parties", label: "Related parties" },
