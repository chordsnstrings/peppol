    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto grid max-w-5xl gap-12 px-5 py-14 lg:grid-cols-[1fr_0.9fr] lg:py-20">
        ...
        <div className="w-full max-w-md">
          ...
          <p className="mt-2 text-base mkt-soft">14 days of full FTA transmission. No card required.</p>
          ...
          <form onSubmit={submit} className="mt-8 space-y-4">
            ...
            <p className="mkt-mono text-center text-[11px] mkt-soft">
              By continuing you agree to our terms. Prices are VAT-inclusive.
            </p>
          </form>

          <p className="mt-6 text-sm mkt-soft">
          ...
          <div className="rounded-2xl border p-6" style={{ borderColor: "var(--ink-line)", background: "var(--ink-2)" }}>
            {summary ? (
              <>
                ...
                <p className="mt-2 text-sm mkt-soft">
                ...
                <p className="mt-3 rounded-lg px-3 py-2 text-[12px] mkt-soft" style={{ background: "var(--ink-3)" }}>
            ...
            <ul className="mt-6 space-y-3 border-t pt-6" style={{ borderColor: "var(--ink-line)" }}>
              {PROOF.map((p) => (
                <li key={p} className="flex items-start gap-2.5 text-sm mkt-soft">
            ...
            <div className="mkt-mono mt-6 flex items-center gap-2 border-t pt-5 text-[11px] mkt-soft" style={{ borderColor: "var(--ink-line)" }}>
...
function SignupField({
  ...
  return (
    <label className="block">
      <span className="mkt-mono mb-1.5 block text-[11px] uppercase tracking-wider mkt-soft">{label}</span>
      <input
        type={type}
        value={value}
        ...
        required={required}
        minLength={minLength}
        className="mkt-input w-full rounded-lg border px-3.5 py-2.5 text-sm transition-colors"
