...
import { Ban, CheckCircle2, Lock, Wallet, KeyRound, Unplug, ShieldOff } from "lucide-react";
...
export function TenantActions({ orgId, detail, canWrite, onDone }: { orgId: string; detail: Detail; canWrite: boolean; onDone: () => void }) {
